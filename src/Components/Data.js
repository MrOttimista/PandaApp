...
class Data extends Component{
  ...
  render(){
    return(
      <Row style={{height:"600px",backgroundColor:"#395454",top:"-180px"}} id={"3"}>
      ...
      <p style={{width:"400px",fontSize:"18px",color:"white"}}>I am a passionate User Experience Developer who has been practicing and training in this field for more than 14 months now.I am a Junior Computer Engineering student at Nile University
      ...
      <img  src={poPanda4} width={"60%"} height={"90%"} style={{paddingTop:"20px"}}/>
      </Col>
      ...
      <p style={{width:"400px",fontSize:"18px",color:"white"}}>I got two internships in Optomatica for 4 months where I started my journey in web development. Then I got a certificate from CodeCamp in JavaScript and datastructure and algorithms. I started to learn on my own and build some web apps as projects. </p>
