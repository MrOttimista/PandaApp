...
class MainApp extends Component{
  ...
  render(){
    return(
      <Router>
      <Layout>
    <Header style={{ position: 'fixed', zIndex: "2",width:"100%", height:"80px",opsity:".25" ,height:"auto"}}>
    ...
    <Content style={{ padding: '0 0', marginTop: 0,backgroundColor:"white",bottom:"-200px",width:"100%"}}>
